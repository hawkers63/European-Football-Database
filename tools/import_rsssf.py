...
ALIASES = {
    ...
    "ask vorwarts (berlin)": "vorwarts",
    "1fc nurnberg": "nurnberg",
    "1 fc nurnberg": "nurnberg",
    "fc nurnberg": "nurnberg",
    "hibernians": "hibernians_malta",
    "hibernians (paola)": "hibernians_malta",
    ...
    "b 1913 (odense)": "b1913",
    "b1913 odense": "b1913",
    "haka (valkeakoski)": "haka",
    "valkeakosken haka": "haka",
    "haka valkeakoski": "haka",
    "standard cl (liege)": "standard",
    "standard cl liege": "standard",
    "fk austria (wien)": "austria_wien",
    "fk partizan (belgrade)": "partizan",
    "fk partizan (beograd)": "partizan",
    "servette fc (geneve)": "servette",
    "sporting cp (lisbon)": "sporting_cp",
    "ifk goteborg": "ifk_gbg",
    "cca bucuresti": "cca_buc",
    "cdna (sofia)": "cdna_sofia",
    "ca spora luxembourg": "spora",
}
